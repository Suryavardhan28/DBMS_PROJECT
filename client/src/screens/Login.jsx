...
function Copyright() {
  return (
    <Typography color="textprimary" align="center" style={{fontFamily:'Oswald'}}>
      Copyright © 
      <Link color="primary" to='/' style={{fontFamily:'Oswald',color:"#000000",fontWeight:"700",textDecoration:"none"}}>
        SAMSUNG
      </Link>{'  '}
        ...
        <div className={classes.paper}>
          ...
          <form className={classes.form} noValidate>
            ...
            <Grid container>
              ...
              <Grid item>
               <Link to='/SignUp' style={{textAlign:'center',marginLeft:"10vw",textDecorationLine:"none",fontWeight:"800"}}>Don't have an account? <span className={classes.spam} >Sign Up</span></Link>
              </Grid>
            </Grid>
            <Box mt={5}>
              <Copyright />
