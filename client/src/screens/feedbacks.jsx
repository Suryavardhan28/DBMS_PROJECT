        ...
        <Table className={classes.table} size="small" aria-label="a dense table">
          <TableHead style={{background:"#000000"}}>
            <TableRow >
              ...
              <TableCell style={{color:"#ffffff",paddingLeft:"7vw"}}>USER NAME</TableCell>
              <TableCell style={{color:"#ffffff",paddingLeft:"7vw"}}>EMAIL</TableCell>
              <TableCell style={{color:"#ffffff",paddingLeft:"7vw"}}>FEEDBACK</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
          {data.map((row) => (
          <StyledTableRow>
            <StyledTableCell style={{paddingLeft:"7vw"}} >{row.name}</StyledTableCell>
            <StyledTableCell style={{paddingLeft:"7vw"}} align="left">
             {row.email}</StyledTableCell>
            <StyledTableCell style={{paddingLeft:"7vw"}} align="left">
            {row.message}</StyledTableCell>
